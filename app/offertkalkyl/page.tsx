...
export default function Offertkalkyl() {
  ...
  return (
    <div className="px-4 flex items-center justify-center h-screen">
      <div className="sm:min-w-[600px] min-w-full">
        <h1 className="text-center mb-4 text-3xl">Takoffertkalkyl</h1>
        <h2 className="text-center mb-4 text-lg">
          Fyll i dina uppgifter för att få en offert
        </h2>

        <div className="bg-gray p-8 mx-auto rounded-xl shadow-lg">
          <form
